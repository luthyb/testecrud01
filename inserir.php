...
<form action="conexao.php" method="post" name="dadosClientes">
<table border="4">
<table border="1" align="center">
    <tbody>
        <tr>
            <th>Nome</th>
            <th><input type="text" name="nomecliente" value=""></th>
        </tr>
        <tr>
            <th>CPF</th>
            <th><input type="text" name="cpf" value=""></th>
        </tr>
        <tr>
            <th>Email</th>
        ...
        <tr>
            <th><input type="hidden" name="acao" value="inserir"></th>
            <th><input type="submit" name="Enviar" value="Enviar" class="btn btn-secondary">
            <a href="index.php"><input type="button" value="Voltar" class="btn btn-secondary"></a></th>
        </tr>
    </tbody>
</table>
</table>
